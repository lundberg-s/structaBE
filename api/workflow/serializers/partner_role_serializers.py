...
from user.models import Organization, Person
from user.serializers.person_serializers import PersonSerializer, FlatPersonSerializer
from user.serializers.organization_serializers import Organization, FlatOrganizationSerializer
